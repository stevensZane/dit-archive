...
const StudentPortal = () => {
  ...
  useEffect(() => {
    ...
    const hasPendingProjects = projects.some(p => p.analysis_status === 'pending');
      ...
      <main className="max-w-4xl mx-auto pt-32 pb-20 px-6">
        <header className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-slate-500 mt-2 font-medium">Prêt à immortaliser ton travail ?</p>
          </div>
          <button 
        ...
        <section>
          ...
          {fetchLoading ? (
            <div className="py-20 flex flex-col items-center gap-4 text-dit-teal opacity-50">
                ...
                <span className="text-xs font-bold uppercase tracking-widest">Nora consulte les registres...</span>
            </div>
          ) : projects.length > 0 ? (
            ...
            <div className="py-20 text-center bg-white border-2 border-dashed border-slate-100 rounded-[40px]">
              ...
              <p className="text-slate-400 font-bold uppercase text-xs tracking-widest">Ton historique est vide</p>
            </div>
          )}
        </section>
      </main>
