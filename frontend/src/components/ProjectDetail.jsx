...
//   // 1. Initialisation : Chercher dans le cache global d'abord
//   useEffect(() => {
//     const initProject = () => {
...
//         // On cherche le projet spécifique dans la liste cachée
//         const found = allProjects.find(p => String(p.id) === String(id));
        
//         if (found) {
//           setProject(found);
//           setLoading(false); // On a trouvé ! On affiche direct.
//         }
//       }
      
//       // On lance quand même l'appel API pour avoir les données fraîches (ex: compteur de vues, etc.)
//       fetchProject();
//       fetchNoraSummary();
//     };
...
//                   >
//                       <FileText size={20} className="text-[#E91E63]" /> Consulter le Rapport
//                   </a>
//               )}
//             </div>
//           </div>
