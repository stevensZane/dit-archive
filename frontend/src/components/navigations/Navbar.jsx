...
const Navbar = () => {
  ...
  // La ligne "after" est maintenant calée juste sous le texte grâce à un petit ajustement de bottom
  const navLinkClass =
  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-4 py-4 sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center h-16">
        {/* Logo - Taille d'origine préservée */}
        <Link to="/home">
        ...
        <div className="flex items-center space-x-8">
          ...
          {/* Lien Nora avec la ligne parfaitement ajustée aussi */}
          <Link
            to="/nora"
