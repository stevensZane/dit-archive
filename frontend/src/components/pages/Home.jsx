...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto pt-20 pb-16 px-4 mb-10 text-center">
        <h1 className="text-4xl md:text-6xl font-black text-gray-900 mt-20 leading-tight">
        ...
        <p className="text-gray-500 text-lg md:text-xl max-w-2xl mx-auto mb-10">
          La bibliothèque numérique des projets du Dakar Institute of
          Technology.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
          ...
          <Link
            to="/explore"
            className="text-sm font-bold text-[#004751] hover:underline"
          >
            Voir tout →
          </Link>
        </div>
